...
const SEED_NOTIFICATIONS: Notification[] = [
  {
    ...
    message:
      "Google is visiting campus on 15 May for SDE roles. Eligible branches: CSE, IT, ECE.",
    type: "placement",
  ...
  },
  {
    ...
    message:
      "Mid-semester examination results for Semester 6 are now available on the portal.",
    type: "result",
  ...
  },
  {
    ...
    message:
      "Register for the annual 48-hour hackathon. Prizes worth ₹2,00,000. Last date: 10 May.",
    type: "event",
  ...
  },
  {
    ...
    message:
      "Internship selection results for Microsoft SWE Intern are out. Check your email.",
    type: "result",
  ...
  },
  {
    ...
    message:
      "Free workshop on System Design fundamentals by Prof. Sharma. Venue: LT-3, 3 PM.",
    type: "event",
  ...
  },
  {
    ...
    message:
      "Final round results for Amazon SDE-1 campus recruitment have been declared.",
    type: "placement",
  ...
  },
  {
    ...
    message:
      "Annual sports day on 5 May. Register for track events at the PE office.",
    type: "event",
  ...
  },
  {
    ...
    message:
      "End-semester examination timetable for all branches is now live on the portal.",
    type: "result",
  ...
  },
  {
    ...
    message:
      "Last date to register for TCS National Qualifier Test is 8 May. Apply on the TCS portal.",
    type: "placement",
  ...
  },
  {
    ...
    message:
      "Aaruush inter-college cultural festival begins 12 May. Volunteer registration open.",
    type: "event",
  ...
  },
  {
    ...
    message:
      "Students with re-evaluation requests can view updated CGPA from the academic portal.",
    type: "result",
  ...
  },
  {
    ...
    message:
      "Infosys InfyTQ certification exam scheduled for 20 May. Eligible students check email.",
    type: "placement",
  ...
  },
  {
    ...
    message:
      "NSS Blood Donation Camp on 6 May at Main Auditorium. All students welcome.",
    type: "event",
  ...
  },
  {
    ...
    message:
      "Lab internal assessment marks for all departments have been uploaded to the portal.",
    type: "result",
  ...
  },
  {
    ...
    message:
      "Wipro Elite NLTH on-campus drive for 2026 batch. Pre-register by 5 May.",
    type: "placement",
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    Log(
      ...
      "info",
      "lifecycle",
      "App initialized and token set in localStorage"
    );
  }, []);

  const showToast = useCallback(
    (text: string, type: "success" | "info" = "info") => {
  ...
  const recomputeDisplay = useCallback(
    (all: Notification[], n: number) => {
      ...
      Log(
        ...
        "info",
        "priorityInbox",
        `Recomputed top ${n} from ${all.length} notifications`
      );
    },
    []
  );
  ...
  const fetchNotifications = useCallback(async () => {
    ...
    try {
      ...
      Log(
        ...
        "info",
        "api",
        `Notifications fetched — ${SEED_NOTIFICATIONS.length} total, showing top ${topN}`
      );
      ...
      Log(
        ...
        "info",
        "api",
        "Fetch notifications request completed"
      );
    }
  }, [topN, showToast]);
  ...
  const handleTopNChange = (newN: number) => {
    Log(
      ...
      "info",
      "page",
      `User changed Top N from ${topN} to ${newN}`
    );
    setTopN(newN);
  ...
  const handleAddNotification = () => {
    ...
    Log(
      ...
      "info",
      "page",
      `Adding new notification: "${newNotification.title}" (${newNotification.type})`
    );
    ...
    Log(
      ...
      "info",
      "priorityInbox",
      `Inserted and recomputed top ${topN} — now ${newAll.length} total`
    );
  };
      ...
      <div className="hero-section">
        ...
        <div className="hero-content">
          ...
          <h1 className="hero-title">
            <GradientText
              colors={["#FFFFF0", "#C4B49A", "#A69279", "#FFFFF0"]}
              animationSpeed={6}
          ...
          <p className="hero-subtitle">
            Priority Inbox — placement drives, exam results &amp; campus events
      ...
      <div className="dashboard">
        ...
        <div className="action-bar">
          ...
          <div className="priority-select-wrapper">
            <label className="priority-label" htmlFor="topn-select">
              Top N
            </label>
            <select
              id="topn-select"
        ...
        {hasFetched && !loading && displayedNotifications.length > 0 && (
          <>
            ...
            <p className="result-text">
              ...
              {allNotifications.length !== 1 ? "s" : ""} — sorted by type
              weight &amp; recency
            </p>
          </>
        )}
      ...
      {showAddModal && (
        ...
        >
          ...
          >
            ...
            <div className="form-group">
              <label className="form-label" htmlFor="add-message">
                Message
              </label>
              <textarea
                id="add-message"
            ...
            <div className="form-group">
              ...
              <select
                ...
                value={formType}
                onChange={(e) =>
                  setFormType(e.target.value as Notification["type"])
                }
              >
              ...
              <button
                ...
                onClick={() => {
                  Log(
                    ...
                    "info",
                    "page",
                    "Add Notification modal cancelled"
                  );
                  setShowAddModal(false);
                }}
              >
